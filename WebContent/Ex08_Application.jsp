	...
	*/
	...
	/*
		WebContent>> WEB-INF >>lib
  	    		  ...
  	    		  >> b.html
  	    WEB-INF 폴더는 보안폴더
  	    Client가 주소를 알고 있다 하더라도 접근 불가한 경로임
  	    
  	    의도적으로:http://localhost:8090/WebJSP/WEB-INF/web.xml 서버는 404전달
  	    
  	    개발자 문제점)
		Ex02_register.html -> 요청 -> 처리 -> Ex02_register.jsp
		클라이언트가 Ex02_register.jsp 페이지를 직접 접근 못하게...
		WebContent 폴더 안에 있는 자원은 >> Clientr가 모든 접근 가능
		
		**실제 현업 개발 코드는...WebContent 폴더에 없어요
