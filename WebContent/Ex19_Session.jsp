...
Server(웹 서버 : WAS)
		...
		session 객체 생성(필요한 정보 담거나 가져올 수 있다)[고유한 정보]:로그인한 ID(게시판 글쓰기) , 쇼핑몰 구매한 물건 목록, 
														   처음 접속한 시간, 마지막 접속한 시간... 
														  
		JSESSIONID: E3DB6D6FD2BCE1002A952F9263C0 유일값이 동기화 서버와...
		
		100명 사용자 서버에 접속하면 서버는 session 객체 100개 생성
